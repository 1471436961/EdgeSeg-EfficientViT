...
- Scope: `p1b_aggregation_attention_plugin_p1b15a_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.6677 ms |
| Plugin TRT p50 | 67.6127 ms |
| p50 delta (plugin - baseline) | 12.9449 ms |
| p50 speedup (baseline / plugin) | 0.8085x |
| Baseline TRT mean | 55.4034 ms |
| Plugin TRT mean | 66.5504 ms |
| mean delta (plugin - baseline) | 11.1470 ms |
| mean speedup (baseline / plugin) | 0.8325x |
