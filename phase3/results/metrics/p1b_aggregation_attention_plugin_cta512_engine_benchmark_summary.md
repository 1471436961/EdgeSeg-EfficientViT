...
- Scope: `p1b_aggregation_attention_plugin_cta512_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.3795 ms |
| Plugin TRT p50 | 52.3110 ms |
| p50 delta (plugin - baseline) | -2.0685 ms |
| p50 speedup (baseline / plugin) | 1.0395x |
| Baseline TRT mean | 54.4171 ms |
| Plugin TRT mean | 52.5923 ms |
| mean delta (plugin - baseline) | -1.8248 ms |
| mean speedup (baseline / plugin) | 1.0347x |
