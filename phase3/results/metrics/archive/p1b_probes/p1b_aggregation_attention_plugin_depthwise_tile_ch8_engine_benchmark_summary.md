...
- Scope: `p1b_aggregation_attention_plugin_depthwise_tile_ch8_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.2971 ms |
| Plugin TRT p50 | 52.4549 ms |
| p50 delta (plugin - baseline) | -1.8422 ms |
| p50 speedup (baseline / plugin) | 1.0351x |
| Baseline TRT mean | 54.3260 ms |
| Plugin TRT mean | 52.4869 ms |
| mean delta (plugin - baseline) | -1.8391 ms |
| mean speedup (baseline / plugin) | 1.0350x |
