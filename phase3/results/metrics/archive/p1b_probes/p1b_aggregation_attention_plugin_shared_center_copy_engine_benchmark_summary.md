...
- Scope: `p1b_aggregation_attention_plugin_shared_center_copy_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.4829 ms |
| Plugin TRT p50 | 52.8886 ms |
| p50 delta (plugin - baseline) | -1.5944 ms |
| p50 speedup (baseline / plugin) | 1.0301x |
| Baseline TRT mean | 54.5285 ms |
| Plugin TRT mean | 52.8737 ms |
| mean delta (plugin - baseline) | -1.6549 ms |
| mean speedup (baseline / plugin) | 1.0313x |
