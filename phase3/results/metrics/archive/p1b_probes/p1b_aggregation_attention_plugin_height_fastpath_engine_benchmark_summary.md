...
- Scope: `p1b_aggregation_attention_plugin_height_fastpath_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.3872 ms |
| Plugin TRT p50 | 52.5097 ms |
| p50 delta (plugin - baseline) | -1.8775 ms |
| p50 speedup (baseline / plugin) | 1.0358x |
| Baseline TRT mean | 54.4022 ms |
| Plugin TRT mean | 52.6888 ms |
| mean delta (plugin - baseline) | -1.7134 ms |
| mean speedup (baseline / plugin) | 1.0325x |
