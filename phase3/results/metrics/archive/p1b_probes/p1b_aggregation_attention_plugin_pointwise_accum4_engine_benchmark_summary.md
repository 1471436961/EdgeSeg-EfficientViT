...
- Scope: `p1b_aggregation_attention_plugin_pointwise_accum4_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.4527 ms |
| Plugin TRT p50 | 54.1967 ms |
| p50 delta (plugin - baseline) | -0.2560 ms |
| p50 speedup (baseline / plugin) | 1.0047x |
| Baseline TRT mean | 54.4874 ms |
| Plugin TRT mean | 53.7605 ms |
| mean delta (plugin - baseline) | -0.7268 ms |
| mean speedup (baseline / plugin) | 1.0135x |
