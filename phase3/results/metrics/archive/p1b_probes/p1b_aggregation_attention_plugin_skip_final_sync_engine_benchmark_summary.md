...
- Scope: `p1b_aggregation_attention_plugin_skip_final_sync_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.3795 ms |
| Plugin TRT p50 | 53.1226 ms |
| p50 delta (plugin - baseline) | -1.2569 ms |
| p50 speedup (baseline / plugin) | 1.0237x |
| Baseline TRT mean | 54.3967 ms |
| Plugin TRT mean | 53.0423 ms |
| mean delta (plugin - baseline) | -1.3544 ms |
| mean speedup (baseline / plugin) | 1.0255x |
