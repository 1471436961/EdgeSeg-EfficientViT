...
- Scope: `p1b_aggregation_attention_plugin_pointwise_accum_probe`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.4502 ms |
| Plugin TRT p50 | 52.4308 ms |
| p50 delta (plugin - baseline) | -2.0193 ms |
| p50 speedup (baseline / plugin) | 1.0385x |
| Baseline TRT mean | 54.4672 ms |
| Plugin TRT mean | 52.8132 ms |
| mean delta (plugin - baseline) | -1.6540 ms |
