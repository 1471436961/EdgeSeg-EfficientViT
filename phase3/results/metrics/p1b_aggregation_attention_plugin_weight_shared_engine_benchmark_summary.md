...
- Scope: `p1b_aggregation_attention_plugin_weight_shared_cold_rerun`

| Item | Value |
|---|---:|
| Baseline TRT p50 | 54.3063 ms |
| Plugin TRT p50 | 53.5301 ms |
| p50 delta (plugin - baseline) | -0.7762 ms |
| p50 speedup (baseline / plugin) | 1.0145x |
| Baseline TRT mean | 54.3009 ms |
| Plugin TRT mean | 53.5409 ms |
| mean delta (plugin - baseline) | -0.7600 ms |
| mean speedup (baseline / plugin) | 1.0142x |
