...
| P1b Nsight attribution | [`results/metrics/p1b_aggregation_attention_plugin_nsys_attribution_summary.md`](results/metrics/p1b_aggregation_attention_plugin_nsys_attribution_summary.md) | 定位 P1b 退化来源：Plugin layer `6.189ms/iter`，其中自写 depthwise/grouped pointwise aggregation kernel 合计约 `4.889ms/iter` |
